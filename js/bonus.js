// BONUS 1 tout ranger dans un gros objet :

var app = {
    // variables => propriétés de l'objet app
    gridSize: 8,
    // les fonctions => des méthodes de l'objet app
    drawBoard: function() {
        // on séléctionne notre élément HTML qui contiendra la grille
        var boardElem = document.querySelector('#invader');
        // width: calc(12 * 25px);
        boardElem.style.width = `${app.gridSize * 25}px`;
        ...
        // on va créer une ligne dans notre board :
            ...
            // on crée une case :
                ...
                squareElem.addEventListener('click', app.handlePixelClick);
    ...
    fillConfigurationForm: function() {
        ...
        formElem.addEventListener('submit', app.handleSubmitForm);
